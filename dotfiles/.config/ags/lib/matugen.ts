...
export default function init() {
    ...
    options.look.theme.autotheme.connect("changed", () => matugen())
}
...
export async function matugen(
    ...
    animate(
        ...
        () => {
            ...
            options.bar.battery.charging.value = options.look.theme.scheme.value === "dark"
