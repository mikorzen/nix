...
export async function tmux() {
    const { scheme, dark, light } = options.look.theme
...
export default function init() {
    options.look.theme.dark.primary.bg.connect("changed", tmux)
    options.look.theme.light.primary.bg.connect("changed", tmux)
}
